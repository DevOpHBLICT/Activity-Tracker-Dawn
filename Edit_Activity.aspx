<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Edit_Activity.aspx.cs" Inherits="_Default" %>
...
SelectCommand="SELECT [Project_name] FROM [ProjectHierarchy] where Current_Project='Y'" >
 </asp:SqlDataSource>
