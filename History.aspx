<%@ Page Title="Activities" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="History.aspx.cs" Inherits="Account_Manage" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <asp:Label Align="center" ID="Label3" runat="server" Text="Click on Calendar for that day's activities. Daily total in blue box." style="font-weight: 700"></asp:Label>
      <br />
  ...
  <asp:Calendar  OnDayRender="Calendar1_DayRender" ID="Calendar" runat="server" ForeColor="Black" BackColor="White" BorderColor="Black" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" Height="200px" ShowGridLines="True" Width="220px">
...
<TodayDayStyle BackColor="#009639" ForeColor="White" />
          ...
          <asp:Label ID="Label4" Align="center" runat="server" Text="Double-Click on the cell to edit any activities."></asp:Label>
