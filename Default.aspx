<%@ Page Title="Activities" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Account_Manage" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <asp:Label ID="Label3" runat="server" Text="Last 7 Days Activities" style="font-weight: 700"></asp:Label>
      <br />
      <asp:Label ID="Label4" runat="server" Text="Double-Click on the row to edit any activities."></asp:Label>
