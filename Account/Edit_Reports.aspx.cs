...
public partial class _Default : Page
{
    ...
    protected void Save_Data()
    {
        ...
        if (ok == 1)
        {
           ...
           "project_name ='" + Project.SelectedValue + "'," +
            "quantifiable_measure='" + QM.SelectedValue + "'," +
            "activity='" + Activity.SelectedValue + "'," +
            "time_spent='" + Duration.Text + "'," +
            "other_description=" + "'" + OtherDescription.Text + "'," +
            "comments='" + Comments.Text + "' where record_id = '" + Request.QueryString["id"].ToString() + "'";
...

            {
...

                {
...

                    {
                        ...
                        OtherDescription.Text = ds.Tables[0].Rows[0].ItemArray[11].ToString();
    ...
    protected void ClientList_DropDown()
    {
        ...
        {
            //Your SQL Command
            SqlCommand cmd = new SqlCommand("select * from Client_List", sqlConnection);
    ...
    protected void QM_DropDown()
    {
        ...
        using (SqlConnection sqlConnection = new SqlConnection(strCon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from QM_Hierarchy where Department ='" + Session["Department"] + "';", sqlConnection);
    ...
    protected void Project_DropDown()
    {
        ...
        {
            //Your SQL Command
            SqlCommand cmd = new SqlCommand("select * from ProjectHierarchy where Client_Name ='" + Client.Text + "';", sqlConnection);
